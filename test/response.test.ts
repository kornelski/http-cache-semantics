...
describe('Response headers', () => {
    ...
    test('pre-check tolerated', () => {
        ...
        expect(cache.responseHeaders()['cache-control']).toBe(cc);
    });
    ...
    test('pre-check poison', () => {
        ...
        expect(cache.responseHeaders()['pragma']).toBeUndefined();
    });
    ...
    test('pre-check poison undefined header', () => {
        ...
        expect(cache.responseHeaders()['expires']).toBeUndefined();
    });
    ...
    test('remove hop headers', () => {
        ...
        expect(h.oompa).toBeUndefined();
        expect(h['cache-control']).toBe('public, max-age=333');
        expect(h.date).not.toBe('now');
        expect(h.custom).toBe('header');
        expect(h.age).toBe('11');
